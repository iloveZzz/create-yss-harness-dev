...
const profiles = {
  ...
  matt: {
    ...
    markers: [["docs/agents/digital-human-roles.yaml", "role.architecture-agent"], ["docs/process/lifecycle-registry.yaml", "stage.technical-design"], ["docs/agents/skill-migrations.md", "yss-stage-decision"], [".agents/skills/harness-orchestrator/SKILL.md", "四角色"]]
  },
  prototype: {
